...
- General: If you're unsure of the root cause of an issue, you may file it in
  ...
  - UCP: Bugs may be filed using github issues for specific projects:
    - `Airship Armada <https://github.com/openstack/airship-armada>`_
    - `Airship Berth <https://github.com/openstack/airship-berth>`_
    - `Airship Deckhand <https://github.com/openstack/airship-deckhand>`_
    - `Airship Divingbell <https://github.com/openstack/airship-divingbell>`_
    - `Airship Drydock <https://github.com/openstack/airship-drydock>`_
    - `Airship MaaS <https://github.com/openstack/airship-maas>`_
    - `Airship Pegleg <https://github.com/openstack/airship-pegleg>`_
    - `Airship Promenade <https://github.com/openstack/airship-promenade>`_
    - `Airship Shipyard <https://github.com/openstack/airship-shipyard>`_
