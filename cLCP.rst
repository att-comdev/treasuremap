...
::
    ...
    NewSite/site-definition.yaml

- data/aic_revision: Set to the desired AIC revision (e.g., v4.0)
- data/site_type: Set to the desired AIC site type (e.g., large)
